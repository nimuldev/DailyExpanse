...
//     ,Amount ="+amount+",Date ="+date+",Time ="+time+",Image ="+image+"
                        ...
                        Toast.makeText(Data_Edit.this, "Updated", Toast.LENGTH_SHORT).show();

                        int i = 1;
                        Intent intent = new Intent(Data_Edit.this, MainActivity.class);
                        intent.putExtra("check", 1);
                        startActivity(intent);
    ...
    public void retionBtn(View view) {
            ...
            imageIv.setRotation(imageIv.getRotation() + 90);
